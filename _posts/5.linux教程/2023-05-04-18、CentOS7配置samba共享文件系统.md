...
smb.conf文件的参数非常多，也很麻烦，如果您有更多的需求，请阅读/etc/samba/smb.conf.example文件，或man
5 smb.conf查看帮助。
...
[　　pdbedit --a username：新建Samba账户。]{.mark}
...
[说明：browseable用来指定该共享是否可以浏览。]{.mark}
